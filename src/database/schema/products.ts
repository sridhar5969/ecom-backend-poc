...
export const products = pgTable('products', {
    ...
    canonicalCategoryId: uuid('canonical_category_id').references(() => categories.id),
    title: varchar('title'),
    flags: jsonb('flags'),
    slug: varchar('slug').unique(),
    description: text('description'),
...
export const bundleComponents = pgTable('bundle_components', {
    parentVariantId: uuid('parent_variant_id').references(() => productVariants.id),
...
export const productVariantsRelations = relations(productVariants, ({ one, many }) => ({
    ...
    bundleComponents: many(bundleComponents, { relationName: 'bundle_parent' }),
    includedInBundles: many(bundleComponents, { relationName: 'bundle_child' }),
}));
